...
export default function ContactPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // fallback — still show success UX since table may not exist
      setSubmitted(true);
  ...
  const contactInfo = [
    { icon: Phone, label: 'Phone', value: '+92 300 123 4567', href: 'tel:+923001234567', sub: 'Mon–Sat, 9am–7pm' },
    { icon: Phone, label: 'Landline', value: '+92 42 3456 7890', href: 'tel:+924234567890', sub: 'Business hours' },
    { icon: Mail, label: 'Email', value: 'info@xyzautomobiles.pk', href: 'mailto:info@xyzautomobiles.pk', sub: 'Reply within 24 hrs' },
    { icon: MapPin, label: 'Address', value: 'Plot 15, DHA Phase 5', href: 'https://maps.google.com', sub: 'Lahore, Pakistan' },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="space-y-6">
              <div>
                <h2 className="text-lg font-semibold mb-1">XYZ Automobiles</h2>
                <p className="text-sm text-muted-foreground">Pakistan's premier car marketplace, connecting buyers, sellers, and dealers since 2018.</p>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  {[{ icon: Instagram, href: '#', label: 'Instagram' }, { icon: Facebook, href: '#', label: 'Facebook' }, { icon: Twitter, href: '#', label: 'Twitter' }].map(({ icon: Icon, href, label }) => (
          ...
          <div className="mt-12">
            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="text-base flex items-center gap-2"><MapPin className="w-4 h-4 text-gold" />Find Us — DHA Phase 5, Lahore</CardTitle>
              </CardHeader>
              <CardContent className="p-0 overflow-hidden rounded-b-xl">
                <div className="aspect-[16/6] w-full">
                  <iframe
                    title="XYZ Automobiles Location"
                    src="https://www.openstreetmap.org/export/embed.html?bbox=74.39500%2C31.47000%2C74.43500%2C31.50000&layer=mapnik&marker=31.48500%2C74.41500"
                ...
                <div className="flex items-center justify-between px-4 py-3 border-t border-border">
                  <div>
                    <p className="text-sm font-medium">Plot 15, DHA Phase 5</p>
                    <p className="text-xs text-muted-foreground">Auto Showroom Area, Lahore, Pakistan</p>
                  </div>
                  <a href="https://maps.google.com/?q=DHA+Phase+5+Lahore+Pakistan" target="_blank" rel="noopener noreferrer">
